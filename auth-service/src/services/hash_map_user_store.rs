...
use crate::domain::{UserStore, UserStoreError, user::User};
...
mod tests {
    ...
    async fn test_get_user() {
        ...
        let no_matching_user_result = user_store.get_user("b@test.com").await;
